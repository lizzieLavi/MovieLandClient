  ...
  useEffect(
    async function fetchData() {
      const movies = await axios.get(
        "https://cinemaws.herokuapp.com/api/movies",
        config
      );
    ...
    <div className="container">
      <div className="navbar">
        ...
        <nav>
          <ul>
            ...
            <li>
              <Link className="defaultLink" onClick={logOut} to={"/"}>
                log out
              </Link>
            </li>
          </ul>
      ...
      <div className="top_page">
        ...
        <div className="SearchClass">
          <button
            className="searchBotn"
            onClick={() => loadMoviesFind("Create Movie")}
          >
            <Link to={`/Movies/searchResult`}>
        ...
        <div className="botnsClass">
          <button
            ...
            className="defaultBotn"
          >
            <Link className="defaultLink" to={`/Movies/AllMovies`}>
              All Movies
            </Link>
          </button>
          <button className="defaultBotn">
            {" "}
            <Link className="defaultLink" to={`/Movies/AddMovie`}>
              Add Movie{" "}
            </Link>{" "}
          </button>
        </div>
        ...
        <Switch>
          <Route
            ...
            component={() => (
              <AllMovies
                token={props.token}
                Movies={MoviesList}
                MovieCallback={(movie) => setCurrentMovie(movie)}
                UpdateCallBack={dataUpdated}
              />
            )}
          />
          ...
          {sessionStorage["authenticate"] ? (
            <Route exact path="/Movies/AddMovie">
              <AddMovie token={props.token} UpdateCallBack={dataUpdated} />
            </Route>
          ) : (
            <Redirect to="/" />
          )}
